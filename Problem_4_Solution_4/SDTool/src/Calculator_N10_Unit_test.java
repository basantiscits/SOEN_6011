...
public class Calculator_N10_Unit_test {
  ...
  String sItemNumbersRealNat = "-100,32.8,11.9,0,10.9,31.0.13.2,19999.2.1,20.787,0,1345.12,110,1.20";
   ...
   * Dated : 26-july-2019
   * Version : 1.0
   * Comments Based on requirments No.1 :Requirment No 1 deals with only strings not with Numbers. 
   */
  @Test()
  public void testOnlyStrings() {
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.1 :Requirment No 1 deals with only Numbers not with strings.
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.2 :Natural and real Number has been taken in the account. 
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.3 :SD, Varaince calculated cant be -ve.(Since it has square root so it cant be -ve) 
     * More Comment : Every time you put -ve numbers it will be +ve bcoz sqrt root which dont take -ve values.
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.4 :Suppose population SD for 1 number is 0.0 since Variance is 0.0 than SD is 0.0 too
     * More Comments : We are taking only 1 number in account which is 100.0
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.5 : Large the number and large the diffrence between will result into large SD
     * More Comments :  Large diversified values w.r.t to mean
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.5 :Smallers the number is smaller the Standard devatation result would be.
     * More Comments : Small diversified values w.r.t to mean.
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirments No.6 :Means if input is given you should expect some out put for sure.
     * More Comments : If number is passed with comma than you can expect result for sure.
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirements No.7 : Numbers entered in textfeild should be in form of ,.
     * More Comments :In requirements no. 7 I have wrote space but now some changes done which is replaced by comma.
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirements No.7 : Numbers entered in textfeild should be in form of "," no space is allowed.
     * More Comments :In requirements no. 7 I have wrote space but now some changes done which is replaced by comma.
     */
    @Test()
     ...
     * Dated : 26-july-2019
     * Version : 1.0
     * Comments Based on requirements No.8 : Execute in small amount of time
     * More Comments :Less memory and efficient and durable
     */
    @Test()
    public void testtimetaken() {
     ...
     //There are 5 child function 2)fncCalculateSum(),3)fncCalculateMean(),4)fncCalculateVariance(),5)fncCalculateSD(),6)squareRoot()
